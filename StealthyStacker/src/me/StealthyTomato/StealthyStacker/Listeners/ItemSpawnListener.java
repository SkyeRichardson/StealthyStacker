...
public class ItemSpawnListener implements Listener {
    ...
    public void onItemSpawn(ItemSpawnEvent event){
		...
		EntityStack largestNearbyStack = EntityStackUtils.findLargestEntityStackNearEntity(item, x, y, z);
		...
		} else if(item.getItemStack().getType().equals(((Item) largestNearbyStack.getPrincipalEntity()).getItemStack().getType())) {
